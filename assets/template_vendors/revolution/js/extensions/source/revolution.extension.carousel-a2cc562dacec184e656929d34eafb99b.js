...
jQuery.extend(!0,i,{prepareCarousel:function(e,o,n,d){if("stop"===i.compare_version(t).check)return!1
n=e.carousel.lastdirection=s(n,e.carousel.lastdirection),a(e),e.carousel.slide_offset_target=r(e),void 0!==d?l(e,n,!1,0):null==o?i.carouselToEvalPosition(e,n):l(e,n,!1)},carouselToEvalPosition:function(e,t){var a=e.carousel
...
s.wrapwidth,s.slide_offset,s.maxwidth,s.slide_offset,s.wrapwidth}})
...
e.c.find(".next-revslide").removeClass("next-revslide"),a&&i.callingNewSlide(e.c,s.data("index"))},ease:n})},o=function(e,i){return Math.abs(e)>Math.abs(i)?e>0?e-Math.abs(Math.floor(e/i)*i):e+Math.abs(Math.floor(e/i)*i):e},r=function(e){var t,a,s,l,r,n=0,d=e.carousel
if(void 0!==d.positionanim&&d.positionanim.kill(),"none"==d.slide_globaloffset)d.slide_globaloffset=n="center"===d.horizontal_align?d.wrapwidth/2-d.slide_width/2:0
else{d.slide_globaloffset=d.slide_offset,d.slide_offset=0
var f=e.c.find(".processing-revslide").index(),h="center"===d.horizontal_align?(d.wrapwidth/2-d.slide_width/2-d.slide_globaloffset)/d.slide_width:(0-d.slide_globaloffset)/d.slide_width
h=i.simp(h,e.slideamount,!1),f=(f=f>=0?f:e.c.find(".active-revslide").index())>=0?f:0,n="off"===d.infinity?h-f:(t=h,a=f,s=e.slideamount,r=a-s-t,l=o(l=a-t,s),r=o(r,s),-(Math.abs(l)>Math.abs(r)?r:l)),n*=d.slide_width}return n}})(jQuery)
